...
public class RobotContainer {
    ...
    private void prepareNamedCommands() {
        ...
        NamedCommands.registerCommand("ForceCoralOut", coralClaw.setPercentCommand(-1.0));
        NamedCommands.registerCommand("KillSuperStructure", superstructure.killSuperStructure());
        ...
        NamedCommands.registerCommand("CoralL1WithCoral", superstructure.setSuperState(superstructure.L1).onlyIf(() -> coralClaw.hasPiece()));
        NamedCommands.registerCommand("CoralL2WithCoral", superstructure.setSuperState(superstructure.L2).onlyIf(() -> coralClaw.hasPiece()));
        NamedCommands.registerCommand("CoralL3WithCoral", superstructure.setSuperState(superstructure.L3).onlyIf(() -> coralClaw.hasPiece()));
        NamedCommands.registerCommand("CoralL3WithAlgaeWithCoral", superstructure.setSuperState(superstructure.L3_WITH_ALGAE).onlyIf(() -> coralClaw.hasPiece()));
        ...
        NamedCommands.registerCommand("WaitUntilShouldRaisePreload", Commands.waitUntil(() -> swerve.getPose().getTranslation().getDistance(FieldConstants.GET_REEF_POSITION().getTranslation()) < 2.6));
        NamedCommands.registerCommand("WaitUntilShouldRaiseJ4", Commands.waitUntil(() -> swerve.getPose().getTranslation().getDistance(FieldConstants.GET_REEF_FACE_POSITIONS().get(4).getLeft().getTranslation()) < 1.9));
        NamedCommands.registerCommand("WaitUntilShouldRaiseE4", Commands.waitUntil(() -> swerve.getPose().getTranslation().getDistance(FieldConstants.GET_REEF_FACE_POSITIONS().get(2).getRight().getTranslation()) < 1.9));
        NamedCommands.registerCommand("WaitUntilShouldRaiseA4", Commands.waitUntil(() -> swerve.getPose().getTranslation().getDistance(FieldConstants.GET_REEF_FACE_POSITIONS().get(0).getLeft().getTranslation()) < 2));
        NamedCommands.registerCommand("WaitUntilShouldRaiseB4", Commands.waitUntil(() -> swerve.getPose().getTranslation().getDistance(FieldConstants.GET_REEF_FACE_POSITIONS().get(0).getRight().getTranslation()) < 2));
        ...
        NamedCommands.registerCommand("WaitUntilShouldRaise", Commands.waitUntil(() -> swerve.getPose().getTranslation().getDistance(FieldConstants.GET_REEF_POSITION().getTranslation()) < 3.5));
